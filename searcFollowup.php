                    ...
                    if($sType != "" || $sStatus != "" || $sDate != "" || $OBNumber != ""){
                        ...
                        if($res  == TRUE){
                          ...
                          <?php
                              ...
                              ?>
                              <tr>
                              <td colspan="9"><span class="fail" style="text-align:center; color: red; font-size:25px; margin: 2rem 1rem;">No results in the database, change your search field!</span></td>
                              </tr>
                              <?php
